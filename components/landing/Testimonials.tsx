...
const testimonials = [
  {
    ...
    content:
      "Our Shopify store conversion rate increased by 52% after the redesign. The custom theme and optimization work exceeded our expectations. Highly recommend!",
    hashtag: "#shopify",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "The WordPress/WooCommerce site they built for us is incredible. The custom features and multi-vendor setup work flawlessly. Our revenue has grown 68% in 6 months.",
    hashtag: "#wordpress",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Professional, responsive, and results-driven. They migrated our entire store from another platform with zero downtime. The new site loads 3x faster and sales are up 45%.",
    hashtag: "#migration",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Outstanding work on our custom e-commerce platform. The team understood our unique requirements and delivered a solution that perfectly fits our business model.",
    hashtag: "#custom",
    rating: 5,
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Real results from real businesses. See how our e-commerce solutions have transformed online stores and driven growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="p-6 h-full bg-white border-gray-200 hover:shadow-2xl transition-all duration-300 relative overflow-hidden group">
