...
import { Store, CheckCircle2, TrendingUp, Zap, DollarSign, Clock } from "lucide-react";
...
export function WordPressCaseStudy() {
  ...
  const metrics = [
    { icon: TrendingUp, value: "+38%", label: "Conversion Rate", description: "Average increase" },
    { icon: Zap, value: "1.8s", label: "Load Time", description: "Page speed" },
    { icon: DollarSign, value: "+55%", label: "Revenue Growth", description: "6 months" },
  ];
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-primary-cta/10">
              <Store className="w-6 h-6 text-primary-cta" />
            </div>
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl">
            Build powerful, scalable WordPress e-commerce websites with WooCommerce. We create custom solutions that give you complete control over your online store's functionality and design.
          </p>
        </motion.div>
            ...
            <Card className="p-6 bg-white border-gray-200 shadow-lg overflow-hidden">
              <div className="aspect-video bg-gradient-to-br from-primary-cta/10 via-primary-cta/5 to-transparent rounded-lg flex items-center justify-center border border-gray-200">
                <div className="text-center">
                  <Store className="w-20 h-20 text-primary-cta/30 mx-auto mb-4" />
                  <p className="text-sm text-gray-500">WordPress Store Preview</p>
                </div>
              </div>
            </Card>
          </motion.div>
